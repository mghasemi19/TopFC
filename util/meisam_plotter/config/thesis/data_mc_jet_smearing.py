...
folder_out="plots/data_mc_2.4.37_qcd_thesis/"
...
# lsit of things to write on the plot
sel_nodphi = "met>200 && (baseline_electrons_n+baseline_muons_n)==0 && jets_n>=4 && bjets_n>=3"
write_nodphi=["C. Rizzi PhD Thesis, 36.1 fb^{-1}",
              "0 lepton, #geq 3 b-jets, #geq 4 jets,", "E_{T}^{miss} > 200 GeV"]
name_tag_nodphi="QCD_noDphi"
#Delta#phi^{4j}_{min}>0.4

sel_CR = "met>200 && (baseline_electrons_n+baseline_muons_n)==0 && jets_n>=4 && bjets_n>=3 &&  dphi_min<0.1"
write_CR=["C. Rizzi PhD Thesis, 36.1 fb^{-1}", 
          "0 lepton, #geq 3 b-jets, #geq 4 jets,", "E_{T}^{miss} > 200 GeV, Delta#phi^{4j}_{min} < 0.1"]
name_tag_CR="QCD_CR"

sel_VR1 = "met>200 && (baseline_electrons_n+baseline_muons_n)==0 && jets_n>=4 && bjets_n>=3 &&  dphi_min<0.2 && dphi_min>0.1"
write_VR1=["C. Rizzi PhD Thesis, 36.1 fb^{-1}",
           "0 lepton, #geq 3 b-jets, #geq 4 jets,", "E_{T}^{miss} > 200 GeV, 0.1 < Delta#phi^{4j}_{min} < 0.2"]
name_tag_VR1="QCD_VR1"

sel_VR2 = "met>200 && (baseline_electrons_n+baseline_muons_n)==0 && jets_n>=4 && bjets_n>=3 &&  dphi_min<0.3 && dphi_min>0.2"
write_VR2=["C. Rizzi PhD Thesis, 36.1 fb^{-1}",
           "0 lepton, #geq 3 b-jets, #geq 4 jets,", "E_{T}^{miss} > 200 GeV, 0.2 < Delta#phi^{4j}_{min} < 0.3"]
name_tag_VR2="QCD_VR2"

myqcdsel=[(sel_nodphi, write_nodphi, name_tag_nodphi), (sel_CR, write_CR, name_tag_CR), (sel_VR1, write_VR1, name_tag_VR1), (sel_VR2, write_VR2, name_tag_VR2)]
