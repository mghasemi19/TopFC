...
write_1L=["C. Rizzi PhD Thesis","Simulation, #sqrt{s}=13 TeV, 36.1 fb^{-1}","#geq 1 lepton, #geq 3 b-jets, #geq 4 jets,", "E_{T}^{miss}>200 GeV","Gtt model"]
write_0L=["C. Rizzi PhD Thesis","Simulation, #sqrt{s}=13 TeV, 36.1 fb^{-1}","0 lepton, #geq 3 b-jets, #geq 4 jets,", "E_{T}^{miss} > 200 GeV, #Delta#phi^{4j}_{min}>0.4","Gtt model"]
write_01L=["C. Rizzi PhD Thesis","Simulation, #sqrt{s}=13 TeV, 36.1 fb^{-1}","#geq 3 b-jets, #geq 4 jets, E_{T}^{miss} > 200 GeV,","#Delta#phi^{4j}_{min}>0.4 if 0L","Gtt model"]
...
if True:
    labels=["Background","m(#tilde{g})=2.1 TeV, m(#tilde{#chi}^{0})=1 GeV","m(#tilde{g})=1.9 TeV, m(#tilde{#chi}^{0})=600 GeV"," m(#tilde{g})=1.9 TeV,m(#tilde{#chi}^{0})=1.4 TeV"]
    to_compare=[["ttbar_NoSys","Wjets_220_NoSys","Zjets_220_NoSys","diboson_NoSys","SingleTop_NoSys","TopEW_NoSys"],["Gtt_2100_1_NoSys"],["Gtt_1900_600_NoSys"],["Gtt_1900_1400_NoSys"]]
...
for var in var_def:
    ...
    if "can" in var.keys():
        ...
        name_can = var['def'][0]
    name_can = "Gtt_compare_"+name_can
