...
outfolder="./2017_07_05_sig_SUSY7tag3/"
...
if __name__ == "__main__":
    ...
    var_def += [{'def':("Z_pt",5,50,550),'leg':"p_{T}(l,l) [GeV]",'can':"pt_ll"}]
    ...
    for var in var_def:
        ...
        #sel="((signal_electron_trig_pass || signal_muon_trig_pass) && jets_n>=2 && bjets_n_77>=2 && pt_lep_1>30 && signal_leptons_n==2)*(weight_mc*weight_lumi*weight_btag*weight_elec*weight_muon*weight_jvt)"
        sel="(pass_MET && met>200 && jets_n>=2 && bjets_n_77>=2 && signal_leptons_n==2 && met_sig>5 && Z_pt>80 && Z_mass>80 && Z_mass<100 && mass_bb>90 && mass_bb<150)*(weight_mc*weight_lumi*weight_btag*weight_elec*weight_muon*weight_jvt)"
        write=["#bf{#it{ATLAS}} Internal","#geq2J, #geq2b77, =2L, pT(ll)>80","MET>200, met/#sqrt{HT}>5, m(Z), m(h)"]

        #signals = ["GGM_Zh_200_Zhllbb","GGM_Zh_400_Zhllbb","GGM_Zh_600_Zhllbb","GGM_Zh_800_Zhllbb"]
        #labels = ["m(#tilde{#chi}) = 200 GeV","m(#tilde{#chi}) = 400 GeV","m(#tilde{#chi}) = 600 GeV","m(#tilde{#chi}) = 800 GeV"]
