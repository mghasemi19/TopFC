...
folder_out="plots/data_mc_2.4.37_qcd/"
...
write_CR=["#bf{#it{ATLAS}} Internal","QCD CR","36.1 fb^{-1}"]
name_tag_CR="QCD_CR"

sel_VR1 = "met>200 && (baseline_electrons_n+baseline_muons_n)==0 && jets_n>=4 && bjets_n>=3 &&  dphi_min<0.2 && dphi_min>0.1"
write_VR1=["#bf{#it{ATLAS}} Internal","QCD VR-1","36.1 fb^{-1}"]
name_tag_VR1="QCD_VR1"

sel_VR2 = "met>200 && (baseline_electrons_n+baseline_muons_n)==0 && jets_n>=4 && bjets_n>=3 &&  dphi_min<0.3 && dphi_min>0.2"
write_VR2=["#bf{#it{ATLAS}} Internal","QCD VR-2","36.1 fb^{-1}"]
name_tag_VR2="QCD_VR2"

myqcdsel=[(sel_CR, write_CR, name_tag_CR), (sel_VR1, write_VR1, name_tag_VR1), (sel_VR2, write_VR2, name_tag_VR2)]
