...
'1L_3bin':{
        ...
        'write':["#bf{#it{ATLAS}} Internal","1L, #geq3b, #geq4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1}, tag 21.2.27"],
        'folder':"plots/tag_21.2.27/2017/pwr_study/withPWR/1L_3bin/"
        },
'0L_3bin':{
        'sel':"(dphi_min>0.4) && (jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=3",
        'write':["#bf{#it{ATLAS}} Internal","0L, #geq3b, #geq4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1}, tag 21.2.27"],
        'folder':"plots/tag_21.2.27/2017/pwr_study/withPWR/0L_3bin/"
        },
'1L_2bin':{
        'sel':"(jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, #geq4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1}, tag 21.2.27"],
        'folder':"plots/tag_21.2.27/2017/pwr_study/withPWR/1L_2bin/"
        },
'0L_2bin':{
        'sel':"(dphi_min>0.4) && (jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, #geq4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1}, tag 21.2.27"],
        'folder':"plots/tag_21.2.27/2017/pwr_study/withPWR/0L_2bin/"
        }
