...
#        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, =4J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/1L_4j/"
#        },  
#'1L_5j':{
#        'sel':"pass_MET && (jets_n==5) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, =5J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/1L_5j/"
#        },
#'1L_6j':{
#        'sel':"pass_MET && (jets_n==6) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, =6J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/1L_6j/"
#        },
#'1L_7j':{
#        'sel':"pass_MET && (jets_n==7) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, 7J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/1L_7j/"
#        },
#'1L_8jin':{
#        'sel':"pass_MET && (jets_n>=8) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, #geq8J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/1L_8jin/"
#        },
#'0L_4j':{
#        'sel':"pass_MET && (dphi_min>0.4) && (jets_n==4) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, =4J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/0L_4j/"
#        },
#'0L_5j':{
#        'sel':"pass_MET && (dphi_min>0.4) && (jets_n==5) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, =5J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/0L_5j/"
#        },

#'0L_6j':{
#        'sel':"pass_MET && (dphi_min>0.4) && (jets_n==6) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, =6J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/0L_6j/"
#        },
#'0L_7j':{
#        'sel':"pass_MET && (dphi_min>0.4) && (jets_n==7) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, 7J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/0L_7j/"
#        },
#'0L_8jin':{
#        'sel':"pass_MET && (dphi_min>0.4) && (jets_n>=8) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, #geq8J, E_{T}^{miss}>200 GeV","79.9 fb^{-1} tag 21.2.27"],
#        'folder':"plots/tag_21.2.27/2015-2016-2017/0L_8jin/"
#        },
'1L_3bin':{
        'sel':"(jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=3",
        'write':["#bf{#it{ATLAS}} Internal","1L, #geq3b, #geq4J, E_{T}^{miss}>200 GeV","79.9 fb^{-1}, tag 21.2.27"],
        'folder':"plots/tag_21.2.27/2015-2016-2017/pwr_study/noPWR/1L_3bin/"
        },
'0L_3bin':{
        'sel':"(dphi_min>0.4) && (jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=3",
        'write':["#bf{#it{ATLAS}} Internal","0L, #geq3b, #geq4J, E_{T}^{miss}>200 GeV","79.9 fb^{-1}, tag 21.2.27"],
        'folder':"plots/tag_21.2.27/2015-2016-2017/pwr_study/noPWR/0L_3bin/"
        },
'1L_2bin':{
        'sel':"(jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, #geq4J, E_{T}^{miss}>200 GeV","79.9 fb^{-1}, tag 21.2.27"],
        'folder':"plots/tag_21.2.27/2015-2016-2017/pwr_study/noPWR/1L_2bin/"
        },
'0L_2bin':{
        'sel':"(dphi_min>0.4) && (jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, #geq4J, E_{T}^{miss}>200 GeV","79.9 fb^{-1}, tag 21.2.27"],
        'folder':"plots/tag_21.2.27/2015-2016-2017/pwr_study/noPWR/0L_2bin/"
        }
...
name_infile=dict()
name_infile["diboson"]    =   "/eos/user/c/cmorenom/SUSY_files/Merged_Inputs/Bkg_21.2.27.diboson_nominalOnly.root"
name_infile["Z_jets"]     =   "/eos/user/c/cmorenom/SUSY_files/Merged_Inputs/Bkg_21.2.27.Z_jets_nominalOnly.root"
name_infile["W_jets"]     =   "/eos/user/c/cmorenom/SUSY_files/Merged_Inputs/Bkg_21.2.27.W_jets_nominalOnly.root"
name_infile["topEW"]      =   "/eos/user/c/cmorenom/SUSY_files/Merged_Inputs/Bkg_21.2.27.topEW_nominalOnly.root"
name_infile["singletop"]  =   "/eos/user/c/cmorenom/SUSY_files/Merged_Inputs/Bkg_21.2.27.singletop_hybrid_nominalOnly.root"
name_infile["ttbar"]      =   "/eos/user/c/cmorenom/SUSY_files/Merged_Inputs/Bkg_21.2.27.ttbar_nominalOnly.root"
name_infile["Data"]       =   "/eos/user/c/cmorenom/SUSY_files/Merged_Inputs/Data_21.2.27.root"

# create myweights, a *single* string with the weights to be used sepatated by a *
weights = ["weight_mc","weight_lumi_real","weight_btag","weight_elec","weight_muon","weight_jvt","weight_WZ_2_2"]
