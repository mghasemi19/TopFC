...
for i in range(len(labels)):
    name_infile_1=dict()
    if i>0:
        name_infile_1[to_compare[i][0]]="/nfs/pic.es/user/c/crizzi/scratch2/susy_EW/HF_inputs/tag.2.4.37-0-X_appoZ/Zjets_221_tag.2.4.37-0-X_useMET300400.root"
    else:
        ...
        name_infile_1[to_compare[i][0]]="/nfs/pic.es/user/c/crizzi/scratch2/susy_EW/HF_inputs/tag.2.4.37-0-X/Zjets_tag.2.4.37-0-X_useMET300400.root"
