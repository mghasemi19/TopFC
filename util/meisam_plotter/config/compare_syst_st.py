...
write=["#bf{#it{ATLAS}} Internal","0L, #geq2b, 4-6J, E_{T}^{miss}>200 GeV, D#phi>0.4","36.1 fb^{-1}"]
...
labels=["nominal","rad_high","rad_low"]
to_compare=[["SingleTop"],["SingleTop_rad_high"],["SingleTop_rad_low"]]
...
for i in range(len(labels)):
    name_infile_1=dict()
    #if i>0:
    #    name_infile_1[to_compare[i][0]]="/nfs/pic.es/user/c/crizzi/scratch2/susy_EW/HF_inputs/tag.2.4.33-5-0_3b_ttbar_syst/ttbar_syst_and_nom_tag.2.4.33-5-0_3b_useMET300400_nominal.root"
    #else:
    #    #name_infile_1[to_compare[i][0]]="/nfs/pic.es/user/c/crizzi/scratch2/susy_EW/HF_inputs/tag.2.4.33-5-0_3b/Bkg_tag.2.4.33-5-0_3b.root"
    #    name_infile_1[to_compare[i][0]]="/nfs/pic.es/user/c/crizzi/scratch2/susy_EW/HF_inputs/tag.2.4.37-0-X/ttbar_tag.2.4.37-0-X_useMET300400.root"
    name_infile_1[to_compare[i][0]]="/nfs/pic.es/user/c/crizzi/scratch2/susy_EW/HF_inputs/tag.2.4.33-5-0_3b_st_syst/SingleTop_tag.2.4.33-5-0_3b_appotest_nominal.root"
