...
'1L_4j':{
        ...
        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, =4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
        'folder':"plots/tag_21.2.27/2017/mc16d_prw/1L_4j/"
        },  
'1L_5j':{
        'sel':"pass_MET && (jets_n==5) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, =5J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
        'folder':"plots/tag_21.2.27/2017/mc16d_prw/1L_5j/"
        },
'1L_6j':{
        'sel':"pass_MET && (jets_n==6) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, =6J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
        'folder':"plots/tag_21.2.27/2017/mc16d_prw/1L_6j/"
        },
'1L_7j':{
        'sel':"pass_MET && (jets_n==7) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, 7J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
        'folder':"plots/tag_21.2.27/2017/mc16d_prw/1L_7j/"
        },
#'1L_8jin':{
#        'sel':"pass_MET && (jets_n>=8) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, #geq8J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
#        'folder':"plots/tag_21.2.27/2017/mc16d_prw/1L_8jin/"
#        },
#'0L_4j':{
#        'sel':"pass_MET && (dphi_min>0.4) && (jets_n==4) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, =4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
#        'folder':"plots/tag_21.2.27/2017/mc16d_prw/0L_4j/"
#        },
#'0L_5j':{
#        'sel':"pass_MET && (dphi_min>0.4) && (jets_n==5) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, =5J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
#        'folder':"plots/tag_21.2.27/2017/mc16d_prw/0L_5j/"
#        },
#'0L_6j':{
#        'sel':"pass_MET && (dphi_min>0.4) && (jets_n==6) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, =6J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
#        'folder':"plots/tag_21.2.27/2017/mc16d_prw/0L_6j/"
#        },
'0L_7j':{
        'sel':"pass_MET && (dphi_min>0.4) && (jets_n==7) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, 7J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
        'folder':"plots/tag_21.2.27/2017/mc16d_prw/0L_7j/"
        },
'0L_8jin':{
        'sel':"pass_MET && (dphi_min>0.4) && (jets_n>=8) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, #geq8J, E_{T}^{miss}>200 GeV","43.8 fb^{-1} tag 21.2.27 mc16d"],
        'folder':"plots/tag_21.2.27/2017/mc16d_prw/0L_8jin/"
        },
'1L_3bin':{
        'sel':"(jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=3",
        'write':["#bf{#it{ATLAS}} Internal","1L, #geq3b, #geq4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1}, tag 21.2.27 mc16d"],
        'folder':"plots/tag_21.2.27/2017/mc16d_prw/1L_3bin/"
        }
#'0L_3bin':{
#        'sel':"(dphi_min>0.4) && (jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=3",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq3b, #geq4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1}, tag 21.2.27 mc16d"],
#        'folder':"plots/tag_21.2.27/2017/mc16d_prw/0L_3bin/"
#        },
#'1L_2bin':{
#        'sel':"(jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n>=1) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","1L, #geq2b, #geq4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1}, tag 21.2.27 mc16d"],
#        'folder':"plots/tag_21.2.27/2017/mc16d_prw/1L_2bin/"
#        },
#'0L_2bin':{
#        'sel':"(dphi_min>0.4) && (jets_n>=4) &&  (met>200) && (signal_electrons_n+signal_muons_n==0) && bjets_n>=2",
#        'write':["#bf{#it{ATLAS}} Internal","0L, #geq2b, #geq4J, E_{T}^{miss}>200 GeV","43.8 fb^{-1}, tag 21.2.27 mc16d"],
#        'folder':"plots/tag_21.2.27/2017/mc16d_prw/0L_2bin/"
#        }
...
name_infile=dict()
name_infile["diboson"]    =   "/eos/user/c/cmorenom/SUSY_files/Bkg_21.2.27_mc16d.diboson_nominalOnly.root"
name_infile["Z_jets"]     =   "/eos/user/c/cmorenom/SUSY_files/Bkg_21.2.27_mc16d.Z_jets_nominalOnly.root"
name_infile["W_jets"]     =   "/eos/user/c/cmorenom/SUSY_files/Bkg_21.2.27_mc16d.W_jets_nominalOnly.root"
name_infile["topEW"]      =   "/eos/user/c/cmorenom/SUSY_files/Bkg_21.2.27_mc16d.topEW_nominalOnly.root"
name_infile["singletop"]  =   "/eos/user/c/cmorenom/SUSY_files/Bkg_21.2.27_mc16d.singletop_hybrid_nominalOnly.root"
name_infile["ttbar"]      =   "/eos/user/c/cmorenom/SUSY_files/Bkg_21.2.27_mc16d.ttbar_nominalOnly.root"
