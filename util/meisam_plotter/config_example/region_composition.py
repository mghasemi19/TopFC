...
backgrounds_name=["diboson","Z_jets","W_jets","topEW","singletop","ttbar"]
backgrounds = [b + "_nominal" for b in backgrounds_name]
...
for b in backgrounds:
    name_infile[b] = "/eos/atlas/user/c/crizzi/susy_multib/ntuples_HF/tag21.2.27_3b_merged/Bkg_21.2.27_all.root"
...
weights = ["weight_mc","weight_lumi_real","weight_btag","weight_elec","weight_muon","weight_jvt"]
...
region_composition(json_file,  backgrounds,myweights, name_infile, labels, slices=["1"], region=region_sel, name_can="Gtt_1L_bkg", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Gtt_0L_B,VR_Gtt_0L_B,SR_Gtt_0L_B,CR_Gtt_0L_M,VR_Gtt_0L_M,SR_Gtt_0L_M,CR_Gtt_0L_C,VR_Gtt_0L_C,SR_Gtt_0L_C"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=["1"], region=region_sel, name_can="Gtt_0L_bkg", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")
...
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=["1"], region=region_sel, name_can="Gbb_bkg", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")
...
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=["1"], region=region_sel, name_can="Hnj_bkg", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")
...
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=["1"], region=region_sel, name_can="Inj_bkg", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")
...
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=["1"], region=region_sel, name_can="Lnj_bkg", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")
...
region_sel = "CR_Gtt_1L_B,VR1_Gtt_1L_B,VR2_Gtt_1L_B,SR_Gtt_1L_B,CR_Gtt_1L_M,VR1_Gtt_1L_M,VR2_Gtt_1L_M,SR_Gtt_1L_M,CR_Gtt_1L_C,VR1_Gtt_1L_C,VR2_Gtt_1L_C,SR_Gtt_1L_C"
region_composition(json_file,  backgrounds,myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Gtt_1L_HF", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Gtt_0L_B,VR_Gtt_0L_B,SR_Gtt_0L_B,CR_Gtt_0L_M,VR_Gtt_0L_M,SR_Gtt_0L_M,CR_Gtt_0L_C,VR_Gtt_0L_C,SR_Gtt_0L_C"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Gtt_0L_HF", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Gbb_B,VR_Gbb_B,SR_Gbb_B,CR_Gbb_M,VR_Gbb_M,SR_Gbb_M,CR_Gbb_C,VR_Gbb_C,SR_Gbb_C,CR_Gbb_VC,VR_Gbb_VC,SR_Gbb_VC"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Gbb_HF", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Hnj_Hmeff,VR0L_Hnj_Hmeff,VR1L_Hnj_Hmeff,SR0L_Hnj_Hmeff,SR1L_Hnj_Hmeff,CR_Hnj_Imeff,VR0L_Hnj_Imeff,VR1L_Hnj_Imeff,SR0L_Hnj_Imeff,SR1L_Hnj_Imeff,CR_Hnj_Lmeff,VR0L_Hnj_Lmeff,VR1L_Hnj_Lmeff,SR0L_Hnj_Lmeff,SR1L_Hnj_Lmeff"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Hnj_HF", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Inj_Imeff,VR0L_Inj_Imeff,VR1L_Inj_Imeff,SR0L_Inj_Imeff,SR1L_Inj_Imeff,CR_Inj_Lmeff,VR0L_Inj_Lmeff,VR1L_Inj_Lmeff,SR0L_Inj_Lmeff,SR1L_Inj_Lmeff"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Inj_HF", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Lnj_Hmeff,VR0L_Lnj_Hmeff,SR0L_Lnj_Hmeff,CR_Lnj_Imeff,VR0L_Lnj_Imeff,SR0L_Lnj_Imeff,CR_Lnj_Lmeff,VR0L_Lnj_Lmeff,SR0L_Lnj_Lmeff,CR_IStR,VR0L_IStR,SR0L_IStR"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Lnj_HF", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")
...
backgrounds=["ttbar_nominal"]
weights = ["weight_mc","weight_lumi_real","weight_btag","weight_elec","weight_muon","weight_jvt"]
myweights = "*".join(weights)

region_sel = "CR_Gtt_0L_B,VR_Gtt_0L_B,SR_Gtt_0L_B,CR_Gtt_0L_M,VR_Gtt_0L_M,SR_Gtt_0L_M,CR_Gtt_0L_C,VR_Gtt_0L_C,SR_Gtt_0L_C"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Gtt_0L_tt", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Gtt_1L_B,VR1_Gtt_1L_B,VR2_Gtt_1L_B,SR_Gtt_1L_B,CR_Gtt_1L_M,VR1_Gtt_1L_M,VR2_Gtt_1L_M,SR_Gtt_1L_M,CR_Gtt_1L_C,VR1_Gtt_1L_C,VR2_Gtt_1L_C,SR_Gtt_1L_C"
region_composition(json_file,  backgrounds,myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Gtt_1L_tt", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Gbb_B,VR_Gbb_B,SR_Gbb_B,CR_Gbb_M,VR_Gbb_M,SR_Gbb_M,CR_Gbb_C,VR_Gbb_C,SR_Gbb_C,CR_Gbb_VC,VR_Gbb_VC,SR_Gbb_VC"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Gbb_tt", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Hnj_Hmeff,VR0L_Hnj_Hmeff,VR1L_Hnj_Hmeff,SR0L_Hnj_Hmeff,SR1L_Hnj_Hmeff,CR_Hnj_Imeff,VR0L_Hnj_Imeff,VR1L_Hnj_Imeff,SR0L_Hnj_Imeff,SR1L_Hnj_Imeff,CR_Hnj_Lmeff,VR0L_Hnj_Lmeff,VR1L_Hnj_Lmeff,SR0L_Hnj_Lmeff,SR1L_Hnj_Lmeff"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Hnj_tt", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Inj_Imeff,VR0L_Inj_Imeff,VR1L_Inj_Imeff,SR0L_Inj_Imeff,SR1L_Inj_Imeff,CR_Inj_Lmeff,VR0L_Inj_Lmeff,VR1L_Inj_Lmeff,SR0L_Inj_Lmeff,SR1L_Inj_Lmeff"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Inj_tt", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")

region_sel = "CR_Lnj_Hmeff,VR0L_Lnj_Hmeff,SR0L_Lnj_Hmeff,CR_Lnj_Imeff,VR0L_Lnj_Imeff,SR0L_Lnj_Imeff,CR_Lnj_Lmeff,VR0L_Lnj_Lmeff,SR0L_Lnj_Lmeff,CR_IStR,VR0L_IStR,SR0L_IStR"
region_composition(json_file, backgrounds, myweights, name_infile, labels, slices=myslice, region=region_sel, name_can="Lnj_tt", write=["ATLAS Internal"], outfolder="./comp_plots_R21/")
